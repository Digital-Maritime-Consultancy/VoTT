...
export enum ActionTypes {
    ...
    LOAD_SEGMENTATION_DATA_SUCCESS = "LOAD_SEGMENTATION_DATA_SUCCESS",
    LOAD_IMAGE_METADATA_SUCCESS = "LOAD_IMAGE_METADATA_SUCCESS",
    LOAD_SVG_SUCCESS = "LOAD_SVG_SUCCESS",
    SAVE_SVG_SUCCESS = "SAVE_SVG_SUCCESS",
